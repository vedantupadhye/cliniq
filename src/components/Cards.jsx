...
const Cards = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row mt-8 lg:mt-28">
      {/* Big blue box with text */}
      <div className="w-full lg:w-2/5 bg-blue-600 text-white p-8 px-12 mr-0 lg:mr-8 rounded-3xl mb-8 lg:mb-0">
        <h2 className="text-4xl lg:text-5xl mt-24 font-bold mb-4">Building Digital HealthCare For Bharat</h2>
        <p className='text-lg lg:text-xl'>Reimagining Health care by bridging the gap between Patient, Payor and Provider , thus making the health care systems more Affordable , Accessible and Interoperable</p>
      </div>
      {/* Cards */}
        ...
        >
          {cardData.map(card => (
            <div key={card.id} className="bg-white rounded-lg shadow-md p-4 mx-4 mb-4">
              <img src={image1} alt={`Card ${card.id}`} className="w-full h-60 object-cover mb-4" />
